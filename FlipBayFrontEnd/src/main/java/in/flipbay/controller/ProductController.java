...
public class ProductController {
	...
	public ModelAndView getProduct(@RequestParam int id) {
		...
		mv.addObject("selectedProductImage",httpSession.getAttribute("productImagesDirectory"));
		return mv;
	}
	
	//this controller to save a product into database
	@PostMapping("/product/save")
	public ModelAndView saveOrUpdateProduct(@RequestParam("productName") String productName,
			...
			@RequestParam("file") MultipartFile file)
	{
		...
		if(productDAO.saveOrUpdate(product)) {	
			...
			fileUtil.fileCopyNIO(file, productID + ".png", productImagesDirectory);
